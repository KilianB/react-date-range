...
class Calendar extends PureComponent {
  ...
  updateShownDate = (props = this.props) => {
    const newProps =
      props.scroll.enabled && this.list
        ? {
            ...props,
  ...
  renderDateDisplay = () => {
    ...
    return (
      <div className={styles.dateDisplayWrapper} ref={inputRef}>
        {ranges.map((range, i) => {
          if (
          ...
          return (
            <div
              ...
              key={i}
              style={{ color: range.color || defaultColor, minWidth: 400 }}
            >
              <DateInput
              ...
              <DateInput
                ...
                onFocus={() => {
                  ...
                  this.handleRangeFocusChange(i, 1);
                }}
                isDateInRange={this.isDateInRange}
              />
            </div>
  ...
  onDragSelectionEnd = (date) => {
    ...
    if (this.props.focusedRange[1] === 1) {
      ...
      if (this.state.isOpen && this.props.onVisibilityChange) {
  ...
  render() {
    ...
    const { scrollArea, focusedDate, isOpen } = this.state;
    ...
    return (
      ...
      >
        <div>{showDateDisplay && this.renderDateDisplay()}</div>

        {isOpen && (
          <div style={{position: 'relative', backgroundColor: 'white', zIndex: 1000}}>
                    ...
                    itemRenderer={(index, key) => {
                      ...
                      return (
                        <Month
                          {...this.props}
                          onPreviewChange={
                            onPreviewChange || this.updatePreview
                          }
